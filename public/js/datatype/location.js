jQuery.fn.locationDatatype = function () {
    ...
    this.prepareContainer = function () {
        ...
        if (!this.readonly) {
            $renderInput.append($('<div class="col-6 col-xs-6"></div>').append(this.$mainInput.addClass('form-control')));
            if (this.$longitudeElement) {
                $renderInput.append($('<div class="col-6 col-xs-6"></div>').append(this.$longitudeElement.addClass('form-control')));
            }
        }
